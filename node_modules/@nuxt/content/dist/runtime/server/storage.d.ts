...
export declare const sourceStorage: import("unstorage/dist/types-227df1cc").S;
export declare const cacheStorage: import("unstorage/dist/types-227df1cc").S;
export declare const cacheParsedStorage: import("unstorage/dist/types-227df1cc").S;
/**
...
export declare const createServerQueryFetch: <T = ParsedContent>(event: H3Event, path?: string) => (query: QueryBuilder<T>) => Promise<T | T[]>;
/**
 * Query contents
 */
...
export declare function serverQueryContent<T = ParsedContent>(event: H3Event, path?: string, ...pathParts: string[]): QueryBuilder<T>;
export {};
