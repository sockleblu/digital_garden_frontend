import fs from 'fs';
import { useLogger, defineNuxtModule, createResolver, extendViteConfig, addPlugin, addImports, addComponentsDir, addTemplate, resolveModule } from '@nuxt/kit';
...
function useContentMounts(nuxt, storages) {
  ...
  if (Array.isArray(storages) || storageKeys.length > 0 && storageKeys.every((i) => i === String(+i))) {
