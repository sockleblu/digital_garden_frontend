...
var emojify = (input, { fallback, format = (name) => name } = {}) => {
  ...
  import_is.assert.string(input);
  import_is.assert.any([import_is.default.undefined, import_is.default.function_], fallbackFunction);
  import_is.assert.function_(format);
